...
<body id="page-top">
  ...
  <section class="jumbotron jumbotron-fluid text-center my-5" style="height: auto;">
    <div class="container mh-100">
      <h1 class="display-1 my-5"> OOPS !</h1>
      <p class="lead my-5">The email has failed to send , please try again.</p>
      <a class="btn btn-primary btn-lg js-scroll-trigger p-4 my-5" href="/">Try Again</a>
    </div>
  </section>
