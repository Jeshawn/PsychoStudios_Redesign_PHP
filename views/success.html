...
<head>
  ...
  <title>Psycho Studios success page</title>
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg sticky-top" id="mainNav">
   ...
   <section class="jumbotron jumbotron-fluid text-center my-5" style="height: auto;">
    <div class="container mh-100">
      <h1 class="display-1 my-5"> Thanks for reaching out !</h1>
      <p class="lead my-5">Your email has been sent successfully , we'll return your message as quickly as possible.</p>
