...
<body id="page-top">
  ...
  <section class="jumbotron jumbotron-fluid text-center my-5" style="height: auto;">
    <div class="container mh-100">
      <h1 class="display-1 my-5"> OOOOH NO 404!</h1>
      <p class="lead my-5">The land you seek does not exist .</p>
      <a class="btn btn-primary btn-lg js-scroll-trigger p-4 my-5" href="/home.php">Return Home !</a>
    </div>
  </section>
